...
// segment base instead of r15, which becomes general-purpose. Segue must be
// disabled, so accesses use the non-Segue (r14 + bundle) sequence.
...
// r15 is general-purpose in GS-context mode: it is sandboxed like any other
// base register when used in a memory access...
movq (%r15), %rax
// CHECK:      .bundle_lock
...
// ...and may be modified freely, unlike in the default r15-context mode.
movq %rax, %r15
// CHECK: movq %rax, %r15
