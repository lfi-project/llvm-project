...
static MCLFIExpander *createX86_64MCLFIExpander(MCStreamer &S, std::unique_ptr<MCRegisterInfo> &&RegInfo, std::unique_ptr<MCInstrInfo> &&InstInfo) {
  auto *Exp =
      new X86::X86MCLFIExpander(S.getContext(), std::move(RegInfo),
                                std::move(InstInfo));
