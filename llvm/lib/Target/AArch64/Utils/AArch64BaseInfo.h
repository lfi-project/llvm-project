...
static inline std::optional<MemInstInfo> getLoadInfo(unsigned Opc) {
  int DestRegIdx;
  int BaseRegIdx;
  int OffsetIdx;
  bool IsPrePost = false;
...
static inline std::optional<MemInstInfo> getStoreInfo(unsigned Opc) {
  int DestRegIdx;
  int BaseRegIdx;
  int OffsetIdx;
  bool IsPrePost = false;
...
static inline bool canConvertToRoW(unsigned Op) {
  unsigned Shift;
