...
//===----------------------------------------------------------------------===//
//
// This file declares the RISCVMCLFIExpander class, the RISCV specific
// subclass of MCLFIExpander.
//
//===----------------------------------------------------------------------===//
#ifndef LLVM_MC_RISCVMCNACLEXPANDER_H
#define LLVM_MC_RISCVMCNACLEXPANDER_H
...
namespace RISCV {
class RISCVMCLFIExpander : public MCLFIExpander {
public:
  RISCVMCLFIExpander(MCContext &Ctx, std::unique_ptr<MCRegisterInfo> &&RI,
